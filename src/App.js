        ...
        <div className="container">                    
          <form className="form-group">
            ...
            <table className="table table-striped" style={{tableLayout: "fixed"}}>
              <thead>
              <tr>
                <th style={{width: "10%"}}><button className="btn btn-sm btn-success" title="Add" onClick={this.addRow}><FontAwesomeIcon icon={faPlus} title="Add"/></button></th>              
                <th style={{width: "40%"}}>Name</th>
                <th style={{width: "40%"}}>Cost</th>
                <th style={{width: "10%"}}><button className="btn btn-sm btn-primary" title="Refresh" onClick={this.init}><FontAwesomeIcon icon={faSync} title="Refresh"/></button></th>
              </tr>
              </thead>
              <tbody>
              {
